...
$statement->bindValue(':pizzaformaat', $_POST['pizzaformaat'], PDO::PARAM_STR);
$statement->bindValue(':sauce', $_POST['sauce'], PDO::PARAM_STR);
$statement->bindValue(':topping', $_POST['topping'], PDO::PARAM_STR);
$statement->bindValue(':spices', $_POST['spices'], PDO::PARAM_STR);
